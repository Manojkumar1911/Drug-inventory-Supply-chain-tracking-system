...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-6xl -mt-12 mx-auto h-[26rem] md:h-[34rem] w-full border-4 border-gradient-to-r from-indigo-500 to-purple-500 p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl overflow-hidden dark:border-indigo-400 dark:border-opacity-50"
    >
