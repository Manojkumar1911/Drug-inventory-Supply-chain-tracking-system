...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-gradient-to-r from-blue-500 to-purple-500 p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl overflow-hidden"
    >
