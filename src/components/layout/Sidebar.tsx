...
const Sidebar: React.FC<SidebarProps> = ({ isMobile = false, closeMobileMenu }) => {
  ...
  return (
    <div className="flex h-full flex-col bg-gradient-to-b from-slate-50 to-slate-100/50 dark:from-slate-900/80 dark:to-slate-800/80 border-r border-slate-200/50 dark:border-slate-800/50">
      <div className="flex h-14 items-center border-b border-slate-200/50 dark:border-slate-800/50 px-4">
