      ...
      <main className="container mx-auto px-4 pt-20 pb-16">
        ...
        <section className="py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why PharmaInventory?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-100 dark:border-gray-700 hover:shadow-lg transition-shadow">
          ...
          <div className="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
            <div className="md:flex">
              <div className="md:flex-1 p-8">
                ...
                <h2 className="mt-2 text-2xl font-bold">Smart Inventory Management</h2>
              ...
              <div className="md:flex-1 bg-blue-100 dark:bg-blue-900 flex items-center justify-center p-8">
        ...
        <section className="py-16 text-center">
          <h2 className="text-3xl font-bold mb-6">Ready to optimize your pharmacy inventory?</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h3 className="font-bold text-xl text-blue-600">PharmaInventory</h3>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8 text-center text-gray-500">
            <p>© {new Date().getFullYear()} PharmaInventory. All rights reserved.</p>
          </div>
        </div>
      </footer>
